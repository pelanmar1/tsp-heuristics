from obj_func import Schwefel
from obj_func import Sphere
from obj_func import Rosenbrock
from obj_func import Rastrigin
...
def simulate(obj_function, colony_size=30, n_iter=5000,
    ...
    for _ in range(simulations):
        optimizer = ABC(obj_function=get_objective(obj_function), colony_size=colony_size, n_iter=n_iter, max_trials=max_trials)
        optimizer.optimize()
